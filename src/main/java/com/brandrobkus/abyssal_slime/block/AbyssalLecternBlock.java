...
public class AbyssalLecternBlock extends BlockWithEntity {
    public static final MapCodec<AbyssalLecternBlock> CODEC = createCodec(AbyssalLecternBlock::new);
    ...
    public MapCodec<AbyssalLecternBlock> getCodec() {
        return CODEC;
    }

    public AbyssalLecternBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new AbyssalLecternBlockEntity(pos, state);
    }
    ...
    private static void putBook(@Nullable LivingEntity user, World world, BlockPos pos, BlockState state, ItemStack stack) {
        ...
        if (blockEntity instanceof AbyssalLecternBlockEntity abyssalLecternBlockEntity) {
            abyssalLecternBlockEntity.setBook(stack.splitUnlessCreative(1, user));
    ...
    private void dropBook(BlockState state, World world, BlockPos pos) {
        ...
        if (blockEntity instanceof AbyssalLecternBlockEntity abyssalLecternBlockEntity) {
            ...
            ItemStack itemStack = abyssalLecternBlockEntity.getBook().copy();
            float f = 0.25F * (float)direction.getOffsetX();
            float g = 0.25F * (float)direction.getOffsetZ();
            ItemEntity itemEntity = new ItemEntity(world, pos.getX() + 0.5F + f, (pos.getY() + 1), pos.getZ() + 0.5F + g, itemStack);
            itemEntity.setToDefaultPickupDelay();
            world.spawnEntity(itemEntity);
            abyssalLecternBlockEntity.clear();
        }
    ...
    private void openScreen(World world, BlockPos pos, PlayerEntity player) {
        BlockEntity blockEntity = world.getBlockEntity(pos);
        if (blockEntity instanceof AbyssalLecternBlockEntity) {
            player.openHandledScreen((AbyssalLecternBlockEntity)blockEntity);
    ...
    static {
        ...
        BOTTOM_SHAPE = Block.createCuboidShape(0.0F, 0.0F, 0.0F, 16.0F, 2.0F, 16.0F);
        MIDDLE_SHAPE = Block.createCuboidShape(4.0F, 2.0F, 4.0F, 12.0F, 14.0F, 12.0F);
        BASE_SHAPE = VoxelShapes.union(BOTTOM_SHAPE, MIDDLE_SHAPE);
        COLLISION_SHAPE_TOP = Block.createCuboidShape(0.0F, 15.0F, 0.0F, 16.0F, 15.0F, 16.0F);
        COLLISION_SHAPE = VoxelShapes.union(BASE_SHAPE, COLLISION_SHAPE_TOP);
        WEST_SHAPE = VoxelShapes.union(Block.createCuboidShape(1.0F, 10.0F, 0.0F, 5.333333, 14.0F, 16.0F), new VoxelShape[]{Block.createCuboidShape(5.333333, 12.0F, 0.0F, 9.666667, 16.0F, 16.0F), Block.createCuboidShape(9.666667, 14.0F, 0.0F, 14.0F, 18.0F, 16.0F), BASE_SHAPE});
        NORTH_SHAPE = VoxelShapes.union(Block.createCuboidShape(0.0F, 10.0F, 1.0F, 16.0F, 14.0F, 5.333333), new VoxelShape[]{Block.createCuboidShape(0.0F, 12.0F, 5.333333, 16.0F, 16.0F, 9.666667), Block.createCuboidShape(0.0F, 14.0F, 9.666667, 16.0F, 18.0F, 14.0F), BASE_SHAPE});
        EAST_SHAPE = VoxelShapes.union(Block.createCuboidShape(10.666667, 10.0F, 0.0F, 15.0F, 14.0F, 16.0F), new VoxelShape[]{Block.createCuboidShape(6.333333, 12.0F, 0.0F, 10.666667, 16.0F, 16.0F), Block.createCuboidShape(2.0F, 14.0F, 0.0F, 6.333333, 18.0F, 16.0F), BASE_SHAPE});
        SOUTH_SHAPE = VoxelShapes.union(Block.createCuboidShape(0.0F, 10.0F, 10.666667, 16.0F, 14.0F, 15.0F), new VoxelShape[]{Block.createCuboidShape(0.0F, 12.0F, 6.333333, 16.0F, 16.0F, 10.666667), Block.createCuboidShape(0.0F, 14.0F, 2.0F, 16.0F, 18.0F, 6.333333), BASE_SHAPE});
    }
}
