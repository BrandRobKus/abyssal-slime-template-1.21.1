package com.brandrobkus.abyssal_slime.block.entity.renderer;
...
public class AbyssalLecternBlockEntityRenderer implements BlockEntityRenderer<AbyssalLecternBlockEntity> {
    private final BookModel book;

    public AbyssalLecternBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
        this.book = new BookModel(ctx.getLayerModelPart(EntityModelLayers.BOOK));
    }

    public void render(AbyssalLecternBlockEntity abyssalLecternBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
        BlockState blockState = abyssalLecternBlockEntity.getCachedState();
