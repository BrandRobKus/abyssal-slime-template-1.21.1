...
public class RenewedEffect extends StatusEffect {
    ...
    public boolean applyUpdateEffect(LivingEntity entity, int amplifier) {
        ...
        if (entity instanceof net.minecraft.server.network.ServerPlayerEntity player
                && world instanceof net.minecraft.server.world.ServerWorld currentWorld) {

            if (player.getHealth() > 4.0F) {
                return true;
            }

            net.minecraft.server.world.ServerWorld targetWorld = currentWorld;
            ...
            player.addStatusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 100, 1, true, true));
            ...
            player.addStatusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 2400, 0, true, true));
        }
